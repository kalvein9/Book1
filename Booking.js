...
function updatePrices() {
    try {
        ...
        // Validate room type
        if (!roomPrices.hasOwnProperty(roomType)) {
...
function updateAdventurePrices() {
    try {
        ...
        var divingCost = divingLocalAdults * divingPrices.localAdults +
            divingLocalKids * divingPrices.localKids +
            divingForeignAdults * divingPrices.foreignAdults +
            divingForeignKids * divingPrices.foreignKids;
        ...
        if (divingLocalAdults>0) {
            bookingInfo += "\nLocal Adult Booking : " + divingLocalAdults;
        } else {
            bookingInfo += "";
        }
    
        if (divingLocalKids>0) {
            bookingInfo += "\nLocal Adult Booking : " + divingLocalKids;
        } else {
            bookingInfo += "";
        }
    
        if (divingForeignAdults) {
            bookingInfo += "\nLocal Adult Booking : " + divingForeignAdults;
        } else {
            bookingInfo += "";
        }
